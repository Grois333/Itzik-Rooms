              ...
              <div class="items__controls">
                <div class="flex" v-if="user">
                  ...
                  <div class="flex items-center mr-4">
                    <img class="w-8 h-8 rounded-full mr-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTp576LQTh1TSrL-OJ-7vSnSHiVYkO7OeuVlw&usqp=CAU" alt="Avatar of Javier Diaz">
                    <div class="text-sm">
