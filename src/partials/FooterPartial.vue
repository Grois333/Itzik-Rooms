<template>
  <footer class="footer mt-6">
    <section class="footer__items bg-white border-t py-6">
      <div class="container grid-container">
        <div class="footer__brand mb-3">
          <p class="text-grey-darkest text-3xl font-semibold mb-2">Itzik Rooms</p>
    ...
    <section class="footer__copyright bg-teal-dark py-4 text-white text-center">
      <div class="container">
        Developed by <a href="http://isaacgroisman.surge.sh/" target="_blank" class="text-white"> Isaac Groisman.</a>
      </div>
    </section>
  </footer>
</template>
