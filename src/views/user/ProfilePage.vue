          ...
          <div class="profile__fields">
            <form class="form">
              <div class="mb-4">
                ...
                <div class="form__field relative">
                  <input v-model="profile.name" class="input__field" id="name" type="text" placeholder="John Doe">
                </div>
              </div>
              <div class="mb-4">
                <label class="input__label" for="username">Username</label>
                <div class="form__field relative">
                  <input v-model="profile.username" class="input__field" id="username" type="text" placeholder="john.doe">
                </div>
              </div>
              <div class="mb-4">
                <label
              ...
              <div class="mb-4">
                ...
                <div class="form__field relative">
                  <textarea
                    ...
                    id="email"
                    type="text"
                    placeholder="john.doe@mail.org"></textarea>
                </div>
              </div>
